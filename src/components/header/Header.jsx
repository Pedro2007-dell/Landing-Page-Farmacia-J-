		...
		<header className="header">
			<div className="header-container">
				<Link to="/" className="logo">
					<img src="/logo.png" alt="Farmácia Já" className="logo-img" />
				</Link>
				...
				<nav className={`nav ${mobileMenuOpen ? "nav-mobile-open" : ""}`}>
					...
					<Link
						to="/medicamentos"
						className={`nav-link ${location.pathname === "/medicamentos" ? "active" : ""}`}
					>
						Medicamentos
					</Link>
					<Link
						to="/farmacias"
						className={`nav-link ${location.pathname === "/farmacias" ? "active" : ""}`}
					>
						Farmácias
					</Link>
					<Link
				...
				<div className="header-actions">
					<Link
						to="/medicamentos?receita=abrir"
						className="btn-receita-indicator"
					>
						<span>📋</span>
						<span>Receita</span>
						{receitaCount > 0 && (
